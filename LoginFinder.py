...
#Fancy banner :p
print ('''\033[1;34m______   ______ _______ _______ _______ _     _ 

  _                 _         ______ _           _           
 | |               (_)       |  ____(_)         | |          
 | |     ___   __ _ _ _ __   | |__   _ _ __   __| | ___ _ __ 
 | |    / _ \ / _` | | '_ \  |  __| | | '_ \ / _` |/ _ \ '__|
 | |___| (_) | (_| | | | | | | |    | | | | | (_| |  __/ |   
 |______\___/ \__, |_|_| |_| |_|    |_|_| |_|\__,_|\___|_|   
               __/ |                                         
              |___/                                       

                          \033[37mMade with \033[91m🫶\033[37m By Udhay\033[1;m''')

print ('''\n  A Simple Tool used to find the Admin Login Pages of a website.\n''')
...
try:
    ...
    if '<html>' in r.text: #if there's an html error page then its not robots.txt
        ...
        print ('  \033[1;32m[+]\033[0m Robots.txt found 🧐. May contain sensitive information.\n')
        print (r.text)
